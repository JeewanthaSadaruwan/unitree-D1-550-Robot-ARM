...
echo "=========================================="
echo "D1-550 Robot - Automated Pick and Place Demo"
echo "=========================================="
echo ""
echo "Starting simulation..."
echo "- RViz with environment markers"
...
killall -9 rviz2 robot_state_publisher joint_state_publisher_gui python3 2>/dev/null
sleep 1

# Launch demo (RViz + robot + environment, NO joint GUI)
